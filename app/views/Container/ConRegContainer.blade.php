...
<div class="large-12 columns large-centered">
	<div class="panel radius custom-panel-1 header panel-hdr-border header-2">
		<label class="size-22 label-title label-black">Confirm Your Information</label>
	</div>
</div>
@endsection
...
{{ Form::open(array('url'=>'Applicant/'.$applicant_info->id.'/Update')) }}
	<div class="large-12 columns">
		@include('Fields.ConfirmRegistration.RegErrors')
		@include('Fields.ConfirmRegistration.BasicDetails')
		@include('Fields.ConfirmRegistration.PersonalInformation')
		@include('Fields.ConfirmRegistration.FamilyDetails')
