...
<div class="large-12 columns large-centered">
	<div class="panel radius custom-panel-1 panel-bg-white sticky fixed">
		<label class="size-22 label-title label-black">NorthStar Solutions Inc. <span class="welcome-label size-14">Logged in as ::{{ link_to('#', ' ' . Auth::user()->firstname . ' ' . Auth::user()->lastname, ['class' => 'small', "data-dropdown"=>"drop1", "aria-controls"=>"drop1", "aria-expanded"=>"false", "class"=>"dropdown"]) }}</label>
