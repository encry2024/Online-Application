...
<div class="large-10 columns large-centered">	
	<div class="panel radius panel-body">
		<div class="panel panel-header cus-pan-hd-3 radius">
			<label class="size-22 label-white large-10 label-mg-left label-ln-ht-1">Family Information</label>
		</div>
...
<div class="large-10 columns large-centered">	
	<div class="panel radius panel-body">
		<div class="panel panel-header cus-pan-hd-3 radius">
			<label class="size-22 label-white large-10 label-mg-left label-ln-ht-1">Character Reference</label>
			<label class="size-13 label-white large-10 label-mg-left label-mrgn-top right push-1"><i>Provide at least 2 persons</i></label>
		</div>
		<div class="panel-body">
