...
<div class="row">
	...
	<div class="large-4 columns">
		<label>Gender</label>
		{{ Form::Select('gender', array('Male'=>'Male', 'Female'=>'Female'), $applicant_info->gender, array('class' => 'lHeight-1')) }}
	</div>
	<div class="large-4 columns">
...
<div class="row">
	...
	<div class="large-4 columns">
		...
		{{ Form::text('dateofbirth', $applicant_info->dateofbirth, ['class'=>'drp-element error text-center radius', 'placeholder'=>'Enter your Date of Birth', 'id'=>'dp1', 'onchange'=>'getAge()']) }}
...
<div class="row">
	<div class="large-6 columns">
		<label>SSS No#</label>
		{{ Form::text('sss', $applicant_info->sss, array('class'=>'error text-center radius', 'placeholder'=>'SSS #')) }}
		@if ($errors->has('sss')) <small class="error">{{ $errors->first('sss') }}</small> @endif
	</div>
	<div class="large-6 columns">
		<label>TIN #</label>
		{{ Form::text('tin', $applicant_info->tin, array('class'=>'error text-center radius', 'placeholder'=>'TIN #')) }}
