...
<div class="row">
	<div class="large-3 columns">
		...
		{{ Form::text('pemployer_1', $applicant_info->pemployer_1, ['class'=>'error text-center radius', 'placeholder'=>'Name of your Previous Employer']) }}
...
<div class="row">
	<div class="large-3 columns">
		<label>Previous Employer</label>
		{{ Form::text('pemployer_2', $applicant_info->pemployer_2, ['class'=>'error text-center radius', 'placeholder'=>'Name of your Previous Employer']) }}
	...
	<div class="large-3 columns">
		<label>Inclusive Dates</label>
		{{ Form::text('pempincdates_2', $applicant_info->pempincdates_2, ['class'=>'text-center radius', 'placeholder'=>'Enter Inclusive Dates']) }}
